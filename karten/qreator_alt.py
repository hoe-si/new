...
<tr><td rowspan="4"><img src="https://www.qrcode-generator.de/phpqrcode/getCode.php?cht=qr&chl=http%3A%2F%2F192.168.178.52%2Fselect.html%3Fid%3D<!-- id pupil --!>&chs=180x180&choe=UTF-8&chld=L|0" height="200" width="200"></td><td>Name:<br><u><!-- Name pupil --!></u></td><td rowspan="2"><img src="smv.png" height="100" width="132"></td></tr>
...
db=dbf.cursor()
plist=db.execute("select distinct gruppen.skto, konto.pin, gruppen.gkto from gruppen,konto where gruppen.skto=konto.kto;").fetchall()
c=0
for i in plist:
	c+=1
	if c % 4 ==0:
